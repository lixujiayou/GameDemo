...
public class NoteDatabaseUtil {
    ...
    public void deleteNote(NoteInfo noteInfo) {
        ...
        if (cursor == null) {
            where = NoteDBHelper.NoteTable.USER_ID + " = '" + userId
                    + "' AND " + NoteDBHelper.NoteTable.NOTE_TITLE + " = '" + noteInfo.getTitle()
                    + "' AND " + NoteDBHelper.NoteTable.NOTE_CONTENT + " = '" + noteInfo.getContent()
    ...
    public long insertNote(NoteInfo noteInfo) {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            contentValues.put(NoteDBHelper.NoteTable.NOTE_TITLE, noteInfo.getTitle());
            contentValues.put(NoteDBHelper.NoteTable.NOTE_CONTENT, noteInfo.getContent());
    ...
    public long insertNote(NoteInfo noteInfo, NoteInfo noteInfoOld, boolean isOffline) {
        ...
        if (userId == null) userId = TRIAL_USER;
        String where = NoteDBHelper.NoteTable.USER_ID + " = '" + userId
                + "' AND " + NoteDBHelper.NoteTable.NOTE_TITLE + " = '" + noteInfoOld.getTitle()
                + "' AND " + NoteDBHelper.NoteTable.NOTE_CONTENT + " = '" + noteInfoOld.getContent()
    ...
    public ArrayList<NoteInfo> queryNoteInfos() {
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            noteInfo.setTitle(cursor.getString(3));
    ...
    public ArrayList<NoteInfo> queryInsertBatchNoteInfos() {
        ...
        String where = NoteDBHelper.NoteTable.USER_ID + " = '" + Students.getObjectByKey( "objectId")
