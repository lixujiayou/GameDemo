...
public class TogtherAdapter extends BaseRecyclerViewAdapter<Togther> {
    ...
    private TogtherAdapter(@NonNull Context context,
                           @NonNull List<Togther> datas) {
        super(context, datas);
    }

    private TogtherAdapter(Builder builder) {
    ...
    @Override
    protected int getViewType(int position, @NonNull Togther data) {
    ...
    public static final class Builder<T> {
        ...
        public TogtherAdapter build() {
            return new TogtherAdapter(this);
        }
