...
public class MultiImageMomentsVHTogther extends TogtherViewHolder implements PhotoContents.OnItemClickListener {


    private PhotoContents imageContainer;
    private InnerContainerAdapter adapter;

    public MultiImageMomentsVHTogther(Context context, ViewGroup viewGroup, int layoutResId) {
