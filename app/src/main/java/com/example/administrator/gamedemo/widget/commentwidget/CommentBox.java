...
public class CommentBox extends FrameLayout {
     ...
     */
    public void toggleCommentBox(@NonNull Share momentid, @Nullable CommentInfo commentInfo, boolean clearDraft) {
        if (isShowing) {
    ...
    public Share getMomentid() {
        return momentid;
    }

    public void setMomentid(Share momentid) {
