...
public class Sq extends SQLiteOpenHelper{
	...
	private String create_1 = "create table user1(_id integer primary key autoincrement,username text,pwd text,name_h text,user_id text,is_upload text,type_ text,erro_ text,erro_select text)";
