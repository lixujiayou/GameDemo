...
public class MomentPresenterAnswer implements IMomentPresenterAnswer {
    ...
    public MomentPresenterAnswer() {
        this(null);
    }

    public MomentPresenterAnswer(IMomentViewTogther momentView) {
