 ...
 * 朋友圈点赞_一起
 */
public class CommentPopup_togther extends BasePopupWindow implements View.OnClickListener {
    ...
    public CommentPopup_togther(Activity context) {
    ...
    public void updateMomentInfo(@NonNull Togther info) {
    ...
    public interface OnCommentPopupClickListener {
        void onLikeClick(View v, @NonNull Togther info, boolean hasLiked);

        void onCommentClick(View v, @NonNull Togther info);
    }
