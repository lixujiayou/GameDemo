...
/**
 * @auther lixu
 * Created by lixu on 2017/4/24 0024.
 */
public class BaseWebViewProgressBar extends View {
    ...
    public BaseWebViewProgressBar(Context context) {
        this (context,null);
        this.mContext = context;
    }
    public BaseWebViewProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs,0);
        this.mContext = context;
    }
    public BaseWebViewProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                Shader.TileMode.MIRROR);
        ...
        paint.setColor(ContextCompat.getColor(mContext,R.color.colorPrimary));//画笔设置颜色
